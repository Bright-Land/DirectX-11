						   ...
						   D3DXMATRIX baseViewMatrix)
{
	...
	result = InitializeSentence(&m_sentence1, 40, device);
	if(!result)
	{
		return false;
	}
	...
	result = UpdateSentence(m_sentence1, "Polygons (VertexCount/3): 5486", 120, 20, 0.6f, 0.6f, 1.0f, deviceContext);
	if(!result)
	{
		return false;
	}
	...
	// Initialize the first sentence.
	result = InitializeSentence(&m_sentence2, 40, device);
	if(!result)
	{
		return false;
	}
	...
	// Now update the sentence vertex buffer with the new string information.
	result = UpdateSentence(m_sentence2, "Objects Number: 6", 120, 40, 0.8f, 0.8f, 1.0f, deviceContext);
	if(!result)
	{
		return false;
	}
	...
	// Now update the sentence vertex buffer with the new string information.
	result = UpdateSentence(m_sentence3, "Screen Size (Pixel): 1920 * 1080", 120, 60, 0.5f, 1.0f, 0.5f, deviceContext);
	if (!result)
	{
		return false;
	}
	...
	// Now update the sentence vertex buffer with the new string information.
	result = UpdateSentence(m_sentence4, "Fps: ", 20, 20, 0.0f, 1.0f, 0.0f, deviceContext);
	if (!result)
	{
		return false;
	}
	...
	// Now update the sentence vertex buffer with the new string information.
	result = UpdateSentence(m_sentence5, "Cpu: ", 20, 40, 0.0f, 1.0f, 0.0f, deviceContext);
	if (!result)
	{
		return false;
	}
	...
	// Now update the sentence vertex buffer with the new string information.
	result = UpdateSentence(m_sentence6, "mouseX: ", 20, 60, 0.0f, 1.0f, 0.0f, deviceContext);
	if (!result)
	{
		return false;
	}
	...
	// Now update the sentence vertex buffer with the new string information.
	result = UpdateSentence(m_sentence7, "mouseY: ", 20, 80, 0.0f, 1.0f, 0.0f, deviceContext);
	if (!result)
	{
		return false;
	}
...
bool TextClass::SetFps(int fps, ID3D11DeviceContext* deviceContext)
{
	...
	result = UpdateSentence(m_sentence4, fpsString, 20, 20, red, green, blue, deviceContext);
	if (!result)
	{
		return false;
	}
...
bool TextClass::SetCpu(int cpu, ID3D11DeviceContext* deviceContext)
{
	...
	// Update the sentence vertex buffer with the new string information.
	result = UpdateSentence(m_sentence5, cpuString, 20, 40, 0.0f, 1.0f, 0.0f, deviceContext);
	if (!result)
	{
		return false;
	}
...
bool TextClass::SetMousePosition(int mouseX, int mouseY, ID3D11DeviceContext* deviceContext)
{
	...
	// Update the sentence vertex buffer with the new string information.
	result = UpdateSentence(m_sentence6, mouseString, 20, 60, 1.0f, 1.0f, 1.0f, deviceContext);
	if (!result)
	{
		return false;
	}
	...
	// Update the sentence vertex buffer with the new string information.
	result = UpdateSentence(m_sentence7, mouseString, 20, 80, 1.0f, 1.0f, 1.0f, deviceContext);
	if (!result)
	{
		return false;
	}
...
bool TextClass::SetPolygons(int &vertexcount, ID3D11DeviceContext* deviceContext)
{
	...
	vertexcount = m_model->GetIndexCount();
	...
	// Update the sentence vertex buffer with the new string information.
	result = UpdateSentence(m_sentence1, polyString, 120, 20, 0.8f, 0.8f, 1.0f, deviceContext);
	if (!result)
	{
		return false;
	}
...
bool TextClass::SetObjects(int num, ID3D11DeviceContext* deviceContext)
{
	char tempString[16];
	char objString[16];
	bool result;
	...
	// Setup the cpu string.
	strcpy_s(objString, "Objects Number: ");
	strcat_s(objString, tempString);

	// Update the sentence vertex buffer with the new string information.
	result = UpdateSentence(m_sentence2, objString, 120, 40, 0.6f, 0.6f, 1.0f, deviceContext);
	if (!result)
	{
		return false;
	}
...
bool TextClass::SetScreenSize(int width, int height, ID3D11DeviceContext* deviceContext)
{
	...
	// Setup the cpu string.
	strcpy_s(screenString, "Screen Size (pixel): ");
	...
	// Update the sentence vertex buffer with the new string information.
	result = UpdateSentence(m_sentence3, screenString, 120, 60, 0.7f, 1.0f, 0.7f, deviceContext);
	if (!result)
	{
		return false;
	}
